...
online_shopper <- read.table("online_shoppers_intention.csv", header = TRUE , sep =",", dec =".")
#----------------DATA CLEANING---------------------------
...
duplicated_online_shopper[!complete.cases(duplicated_online_shopper),]     
...
#You must run ANN algortihm seperately. Because it has different number of neuron and hidden layer combinations.
